...
$cfg['blowfish_secret']					= 'NcxvTL_-M,t:Aj}4H\'3im/&)+@>kdfDA' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_D3ZcIy8WKJwMQxLTlPoX59f/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
...
$cfg['Servers'][$i]['SignonURL']    = 'https://tvadi.hipl-staging1.com/wp-admin/?rand=60527622&goto_wp_phpmyadmin=1';
$cfg['Servers'][$i]['LogoutURL']    = 'https://tvadi.hipl-staging1.com/wp-admin/?rand=21062098&pma_logout=1';
