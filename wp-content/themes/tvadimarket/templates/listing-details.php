...
get_header();
global $wp;
$listingType    =   (isset($wp->query_vars['listing_type']))    ?   $wp->query_vars['listing_type']     : '';
$postid         =   (isset($wp->query_vars['listing_id']))      ?   (int)$wp->query_vars['listing_id']  : '';
...
$duedate                                =   date('m/d/Y', strtotime((string)$duestring));
$postimageurl                           =   wp_get_attachment_url(get_post_thumbnail_id($postid), 'full');

//generate Qr code
$post_permalink                         =   get_permalink($postid);
$QRdata                                 =   (!empty($post_permalink)) ? $post_permalink : $postData->post_title;
$qr_image                               =   generate_qr_code($QRdata);
?>
                ...
                <div class="semi-columns-content-block">
                    ...
                    <div class="content-inner">
                        <div class="description">
                            <?= apply_filters('the_content', $postData->post_content) ?>
                        </div>
                    </div>
                </div>
                <div class="semi-columns-content-block">
                ...
                if(!empty($terms)){
                    ...
                    <div class="semi-columns-content-block">
                        ...
                        foreach($terms as $term){
                            ?>
                            <div class="content-inner"><?= $term->name ?></div>
                            <?php
                        }
                        ?>
                    </div>
            ...
            <div class="right basic">
                <div class="block-inner">
                    ...
                    <div class="discounted">
                        <h4><?= ucfirst($postData->post_title) ?></h4>
                        <div class="basic-img"><img src="<?= $postimageurl ?>" class="img-fluid" alt="<?= ucfirst($postData->post_title) ?>" /></div>
                        <?php 
                        ...
                        <ul>
                            ...
                            <li class="qr-code mb-0 p-0"><span>Listing QR Code:</span>
                                <div class="qr-code-block">
                                    <img src="<?= $qr_image ?>" class="img-fluid" alt="" />
                                </div>
                            </li>
                        </ul>
                    </div>
